...
public class CsvHandler {
    ...
    private final String[] csvHeaders = {"date","hours","employeeGender","employeeParent","description"};
    ...
    public FloatingHoliday convertToHolyDay(Vector<String> attributes){
        ...
        try {
            ...
            if (attributes.elementAt(2).isEmpty()){
                floatingHoliday.setEmployeeGender(Gender.valueOf("FEMALE"));
            }
            else {
                floatingHoliday.setEmployeeGender(Gender.valueOf(attributes.elementAt(2)));
            }
